    ...
    <div>
      ...
      <Form method="POST">
        ...
        <div>
          ...
          <div>
            <input
              className="w-full rounded-full border border-stone-200 px-4 py-2 text-sm ring-yellow-400 transition-all duration-300 placeholder:text-stone-400 focus:outline-none focus:ring md:px-6 md:py-3"
              type="text"
              name="address"
              required
            />
        ...
        <div>
          <input
            className="h-6 w-6 accent-yellow-400 ring-yellow-400 focus:outline-none focus:ring focus:ring-offset-2"
            type="checkbox"
            name="priority"
            id="priority"
            // value={withPriority}
...
export async function action({ request }) {
  ...
  // If everything is ok, create new order and re-direct.
